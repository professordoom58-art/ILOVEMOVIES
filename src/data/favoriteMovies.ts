...
export const FAVORITE_MEDIA: PersonalEntryConfig[] = [
  ...
  }, // 140. The Incredibles Collection (9)
  {
    ...
    tag: 'COLLECTION',
    movieIds: [
      19157, 26291, 9612, 13595, 24070, 11017, 9614, 10723, 11003, 10663,
      9032, 10402, 9678, 11090, 2022, 8051, 13376, 9506, 1824, 2539,
      9291, 9339, 2355, 3563, 10661, 10202, 20829, 38365, 50546, 38317,
      71880, 87428, 76492, 109418, 232672, 284296, 238215, 243684, 257344,
      159824, 347969, 389053, 419700, 396398, 465109, 400155, 514999, 473033,
      617505, 705861, 638974, 999644, 1075794, 636706, 1263256, 1069905
    ]
